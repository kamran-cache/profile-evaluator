...
const Scholarships = () => {
  ...
  const { currentForm, scholarships } = useSelector((state) => state.scholarships);
      ...
      <div className="flex justify-center w-1/2 h-full">
        ...
        <div className="flex flex-col justify-between w-full pl-12 bg-white">
          ...
          <div className="overflow-y-auto overflow-x-hidden w-full h-[35rem] py-4 scrollbar-transparent flex flex-col items-center">
            {/* Heading */}
            <div className="flex text-2xl font-semibold mb-4">Share Your Scholarships & Grants</div>
                  ...
                  >
                    ...
                    <div className="flex">
                      ...
                      <p className="text-gray-500">
                        <strong>Granted by:</strong> {formContent.organisation}
                      </p>
                    </div>
                    {isOpenArray[index] && (
                      <>
