        ...
        {modal && (
          <>
            <div className="relative">
              <Modal setModal={setModal} category={category} />
            </div>
          </>
        )}

        <div className="container ml-12 w-[93%] h-[94%]  ">
          <div className="sections  h-[100%] w-[100%] p-4 flex flex-row space-x-3 overflow-x-auto overflow-y-auto">
              ...
              <div className="heading w-full flex flex-row justify-between p-3 bg-green-200 rounded-lg">
                ...
                <p>
                  <FaPlus
                    ...
                    onClick={() => {
                      setModal(true);
                      setCategory("criticalRole");
                    }}
                  />
                </p>
              </div>
              <div className="overflow-y-auto h-full w-full p-2 overflow-x-hidden">
                {/* State Todo */}
            ...
            <div className="section1 h-[100%] w-[100%]  p-2 bg-pink-100/50 rounded-lg flex flex-col opacity-90">
