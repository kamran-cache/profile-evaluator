  ...
  return (
    <>
      <motion.nav
        ...
        initial="close"
        className=" bg-[#fffff2]  flex flex-col z-20 gap-20 p-5 absolute top-0 left-0 h-full shadow shadow-neutral-600"
      >
        ...
        <div className="flex flex-col gap-3">
          <div>
            <Link
              to="/"
              className="mt-8 p-1 rounded flex cursor-pointer stroke-[0.75] hover:stroke-neutral-100 stroke-blue-400 text-neutral-400 hover:text-blue-700  place-items-center gap-3  transition-colors duration-100"
            >
            ...
            <Link
              to={`/dash/${id}`}
              className=" mt-4 p-1 rounded flex cursor-pointer stroke-[0.75] hover:stroke-neutral-100 stroke-blue-400 text-neutral-400 hover:text-blue-700  place-items-center gap-3  transition-colors duration-100"
            >
            ...
            <Link
              to={`/form/${id}`}
              className=" mt-4 p-1 rounded flex cursor-pointer stroke-[0.75] hover:stroke-blue-800 stroke-neutral-400 text-neutral-400 hover:text-blue-700  place-items-center gap-3  transition-colors duration-100"
            >
