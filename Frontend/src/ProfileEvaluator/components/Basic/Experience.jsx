...
//   console.log(experienceData, "exDa");
...
//                     </div>
//                   </div>
//                   <div className="border-2 border-gray-400/40 rounded-lg p-4">
...
//       </div>
//       <NavigationBtn
//         data={experienceData.isEdited ? experienceData : ""}
//         api={`http://localhost:5000/api/v1/add-data/experience/${id}`}
//         section={"experience"}
//       />
//     </>
//   );
...
const Experience = () => {
  ...
  // Handle input change for form fields (including nested roles array)
  const handleInputChange = (e) => {
    const { name, value } = e.target;
    dispatch(setFormField({ name, value }));
  };

  // Add experience to the Redux store
  const handleAddForm = (e) => {
    e.preventDefault(); // Prevent default form submission
                  ...
                  {experiences.map((formContent, index) => (
                    ...
                    >
                      ...
                      {isToggle && (
                        <>
                          {formContent.roles &&
                            formContent.roles.map((role, roleIndex) => (
                              <div key={roleIndex}>
                                <p className="text-gray-500">
                                  <strong>Role:</strong> {role.jobTitle}
                                </p>
                                <p className="text-gray-500">
