...
const PressRelease = () => {
  ...
  const PRData = useSelector((state) => state.pressRelease);
  ...
  return (
    <>
                ...
                <form className="w-full pr-12" onSubmit={handleAddForm}>
                  ...
                  <div className="-mx-3 flex flex-wrap">
                    ...
                    <div className="w-full px-3">
                      <div className="mb-5">
                        <label className="mb-3 block text-base text-[#07074D]">
                          What is the <strong>Name</strong> of the publication
                          or channel where you were mentioned?
                        </label>
                        <input
                          type="text"
                          name="publication"
      ...
      <NavigationBtn
        data={PRData.isEdited ? PRData : ""}
        api={`http://localhost:5000/api/v1/add-data/pressrelease/${id}`}
