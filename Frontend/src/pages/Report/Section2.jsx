                ...
                <div className="card flex flex-col">
                  ...
                  >
                    ...
                    <div className="w-[6.5vw]">
                      <div
                        className={`visa text-white font-semibold  text-2xl  p-4 text-center flex items-center justify-center rounded-lg ${
                          index % 3 === 0
                  ...
                  {index % 2 === 0 && (
                    <>
                      <div className="flex flex-col items-center h-[21vh] w-[10.9vw]">
                        ...
                        />
                        <p className="text-sm leading-5 text-center text-[#9F9F9F] font-medium">
                          Filed and received approval for O-1 visa based on
                          extraordinary ability in June.
                        </p>
                      </div>
                    </>
                  )}
