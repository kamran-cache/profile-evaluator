            ...
            <div className="mb-0" id="headingOne">
              <button
                className={`${
                  ...
                  `text-primary font-medium text-xl bg-[#D1F7FF]`
                } group relative flex w-full items-center #FBFBFB  rounded-lg  px-5 py-4 text-left text-base  transition  hover:z-[2] focus:z-[3] focus:outline-none  `}
                type="button"
              ...
              >
                {activeElement === "element1" && (
                  <div className="px-5 py-4 bg-[#D1F7FF] text-[#646464] font-normal ">
