...
//   return (
//     <div className="main h-[30rem] w-full bg-[#FF684E]/10 mt-6 font-metropolis">
//       <div className="container h-full w-full flex flex-row items-center justify-center">
//         <div className="left h-full w-1/3 flex justify-center bg-green-600">
//           <div className="mt-6 w-fit h-fit flex flex-col items-start justify-center text-justify bg-blue-500">
...
//           </div>
//         </div>
//         <div className="right h-full w-2/3 bg-yellow-300">
//           {/* ----------------Bar chart ----------------- */}
//           <ResponsiveContainer
//             width="100%"
//             height="100%"
...
//   // return years + (months >= 0 ? months / 12 : (months + 12) / 12).toFixed(1);
//   return years;
// };
...
//       roles.push({ role: role, years: years });
//     });
//     newData.push({ company: company, location: location, roles: roles });
//   });
...
//               <Tooltip />
//               <Legend />
//               <Bar dataKey="years" fill="#8884d8" name="Experience (Years)" />
//             </BarChart>
//           </ResponsiveContainer>
//         </div>
//       </div>
